...
public class RedisUtil {
    ...
    public static final String REDIS_KEY = "ProjectManage:";
    ...
    public ShiroUser getAuthInfo(String token) {
        return JSONObject.parseObject(getString(RedisUtil.REDIS_KEY + "auth_info:" + token), ShiroUser.class);
    }

    public void setAuthInfo(ShiroUser user, String token) {
        set(RedisUtil.REDIS_KEY + "auth_info:" + token, JSONObject.toJSONString(user));
    }

    public SimpleAuthorizationInfo getAuthPermission(String token) {
        return JSONObject.parseObject(getString(RedisUtil.REDIS_KEY + "auth_permission:" + token), SimpleAuthorizationInfo.class);
    }

    public void setAuthPermission(SimpleAuthorizationInfo info, String token) {
        set(RedisUtil.REDIS_KEY + "auth_permission:" + token, JSONObject.toJSONString(info));
    }
...
//            remove(RedisUtil.REDIS_KEY + "user_info:" + userId);
//        }
//    }
